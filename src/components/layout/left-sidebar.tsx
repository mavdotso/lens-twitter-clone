...
import { WelcomeToLens } from '../welcome-to-lens';
            ...
            <div className="relative p-4 w-64 h-full">
                <div className='fixed flex flex-col space-y-4 pb-8 max-w-52 h-full overflow-y-auto'>
                    ...
                    <div className="space-y-1">
                        {menuItems.map((item) => (
                            <Link key={item.name} href={item.href} className="flex items-center hover:bg-gray-200 p-2 rounded-full">
                    ...
                    <Button className="bg-blue-400 px-4 py-2 rounded-full w-full font-bold text-white">
                        Tweet
                    </Button>
