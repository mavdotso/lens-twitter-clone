    ...
    return (
        <div className="top-0 sticky w-1/5 h-screen">
            <div className="p-4 h-full">
                <div className='flex flex-col space-y-4 pb-8 h-full overflow-y-auto'>
                    <div>
                    ...
                    <div className="space-y-1">
                        {menuItems.map((item) => (
                            <Link key={item.name} href={item.href} className="flex items-center hover:bg-gray-100 p-4 rounded-full">
